class General {
    ...
    getSelectedComponentName(element, ancestorIdentifier = '.rooms', elementSelector = 'p') {
        ...
        const name = (_b = (_a = selectedElement === null || selectedElement === void 0 ? void 0 : selectedElement.textContent) === null || _a === void 0 ? void 0 : _a.toLowerCase()) !== null && _b !== void 0 ? _b : '';
        return name;
    }
    ...
    updateComponentData(data) {
        this.componentsData[data.name] = Object.assign(Object.assign({}, this.componentsData[data.name]), data);
    }
